...
from .views import (RetrieveNextDogView, UpdateDogStatusView,
...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^api/dog/(?P<pk>-?\d+)/(?P<type>liked|disliked|undecided)/next/$', RetrieveNextDogView.as_view(), name='next-dog'),
